...
const MealPlans = () => {
    ...
    const calculatePlanPricing = (basePrice, mealCount) => {
    ...
    const plans = [
        {
            ...
            calories: healthProfile?.metrics.final_cal * 0.3 || 0
        },
        {
            id: 'half_day',
            name: 'Half Day',
            ...
            calories: healthProfile?.metrics.final_cal * 0.5 || 0,
            recommended: true
        },
        {
            id: 'full_day',
            ...
            calories: healthProfile?.metrics.final_cal || 0
        }
    ];
                        ...
                        <div className="nutrition-info">
                            ...
                            <div className="nutrition-details">
                                ...
                                <div className="nutrition-item">
                                    ...
                                    <span className="nutrition-value">
                                        {Math.round(healthProfile.metrics.macronutrients.protein * 
                                            (plan.calories / healthProfile.metrics.final_cal))}g
                                    </span>
                                </div>
                            </div>
                        </div>
